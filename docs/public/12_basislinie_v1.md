...
- `net_zrl_shutter_module` als Rolladensteuerung
- `net_sen_weather_station` als netzbetriebenes Umwelt- und Regenmodul
- `net_erl_hall_module` als Flurlicht
- `net_erl_hall_module_led_ring` als Hall-Modul mit LED-Ring
- `bat_sen_window_contact` als Fensterkontakt
- `bat_sen_rain_sensor` als batteriebetriebener Regensensor
