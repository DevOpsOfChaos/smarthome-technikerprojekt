// =============================================================================
// main.cpp – NET-ZRL Shutter Module: Netz-Rollladen (ESP-NOW)
// =============================================================================
// Projekt:    Smarthome Technikerprojekt
// Pfad:       firmware/src/devices/net_zrl_shutter_module/main.cpp
//
// Datei-Funktion:
...
//   DeviceConfig.h, NetZrlProvisioning.h, HardwarePinStandard.h, ProjectVersion.h,
...
#ifndef NET_ZRL_DEFAULT_ESTIMATED_TRAVEL_TIME_MS
...
static_assert(PIN_BUTTON_DOWN != PIN_BUTTON_STOP, "Button-Down und Button-Stop duerfen nicht denselben GPIO nutzen.");
static_assert(PIN_LED_UP != PIN_LED_DOWN, "LED-Up und LED-Down duerfen nicht denselben GPIO nutzen.");
static_assert(PIN_RELAY_A != PIN_BUTTON_UP && PIN_RELAY_A != PIN_BUTTON_DOWN && PIN_RELAY_A != PIN_BUTTON_STOP,
    "Relais-Up darf keinen Button-GPIO teilen.");
static_assert(PIN_RELAY_B != PIN_BUTTON_UP && PIN_RELAY_B != PIN_BUTTON_DOWN && PIN_RELAY_B != PIN_BUTTON_STOP,
    "Relais-Down darf keinen Button-GPIO teilen.");
static_assert(PIN_RELAY_A != PIN_LED_UP && PIN_RELAY_A != PIN_LED_DOWN,
    "Relais-Up darf keinen LED-GPIO teilen.");
static_assert(PIN_RELAY_B != PIN_LED_UP && PIN_RELAY_B != PIN_LED_DOWN,
    "Relais-Down darf keinen LED-GPIO teilen.");
...
constexpr unsigned long DEFAULT_ESTIMATED_TRAVEL_TIME_MS = NET_ZRL_DEFAULT_ESTIMATED_TRAVEL_TIME_MS;
...
//
// SEQUENZ-NUMMER: Alle Wiederholungen verwenden dieselbe Sequenznummer, damit
//                 der Master Retry-Pakete als Duplikate erkennen kann.
// =============================================================================
...
void setzeRelaisNeutral(const char* grund) {
    const bool warRelaisAktiv = runtime.relayAActive || runtime.relayBActive;
...
void setzeRelaisFuerRichtung(CoverDirection direction, const char* grund) {
    ...
    if (runtime.relayAActive || runtime.relayBActive) {
        setzeRelaisNeutral("break-before-make");
    }
...
void setup() {
    ...
    initialisierePin(PIN_BUTTON_UP, buttonInputMode);
    initialisierePin(PIN_BUTTON_DOWN, buttonInputMode);
    initialisierePin(PIN_BUTTON_STOP, buttonInputMode);
