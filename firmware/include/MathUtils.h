...
===============================================================================
 ...
 Beschreibung: Begrenzt Messwerte und erkennt relevante Wertaenderungen ohne unnoetigen Funkverkehr.

 Genutzte Bibliotheken:
 - stdint.h: feste Ganzzahltypen wie uint16_t und uint32_t.
